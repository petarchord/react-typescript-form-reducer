...
const SessionForm: FC = (): ReactElement => {
  ...
  const handleSubmit = (e: SyntheticEvent) => {
    e.preventDefault();
    const { titleError, descriptionError, formatError, levelError } =
      formValues;
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-element">
          ...
          {formValues.titleError && (
            <p className="form-error">{formValues.titleError}</p>
          )}
        </div>
        <div className="form-element">
        ...
        {formValues.formatError && (
          <p className="form-error">{formValues.formatError}</p>
        )}
        <div className="form-element">
          ...
          {formValues.levelError && (
            <p className="form-error">{formValues.levelError}</p>
          )}
        </div>
        <input
          type="submit"
